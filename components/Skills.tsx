    ...
    <section id="skills" className="relative z-10 py-32 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/30">
            <Sparkles className="w-4 h-4 text-cyan-400" />
          ...
          {Object.entries(skillCategories).map(
            ([category, data], categoryIndex) => (
              ...
              >
                ...
                <div
                  className={`absolute -inset-2 rounded-3xl bg-gradient-to-r ${data.color}
                  blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-500`}
                />

                <div className="relative h-full p-6 rounded-2xl bg-gradient-to-br from-gray-900/90 to-gray-800/90 border border-gray-700 backdrop-blur-sm">
                  <div className="mb-6">
                    <div
                      className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br ${data.color} mb-4`}
                    >
                    ...
                    <div
                      className={`h-1 w-12 bg-gradient-to-r ${data.color} rounded-full`}
                    />
                  </div>
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            { icon: Server, label: 'Frameworks', value: '12+' },
            { icon: Database, label: 'Databases', value: '6+' },
            { icon: TrendingUp, label: 'Years XP', value: '5+' },
          ].map(stat => (
            <div
              key={stat.label}
              className="p-6 rounded-xl bg-gray-900/80 border border-gray-700 text-center"
            >
        ...
        <div className="text-center mt-16">
          <button
            ...
            className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg font-semibold"
          >
            View Projects
          </button>
        </div>
